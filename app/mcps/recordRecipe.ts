...
export const transformToRecipe = async (input: string) => {
  ...
  const { object } = await generateObject({
    ...
    system:
      "You are a very good chef. You know how to extract ingredients, calculate cooking time, and methods from the recipe.",
    prompt: input,
...
//     system:
//       "You are a very good chef who can convert recipes into english from multiple languages. You know how to extract ingredients and methods from a voice recording describing the recipe.",
//   });
...
//     schema: recordRecipeSchema,
//     system:
//       "You are a very good chef who can convert recipes into english from multiple languages. You know how to extract ingredients and methods from the recipe.",
